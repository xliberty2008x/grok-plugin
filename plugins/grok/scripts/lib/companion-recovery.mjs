...
import { applyReviewPrivacy, applyTaskPrivacy, currentHost, includeGuardCleanup, reconcileTerminalStopReason, sessionId, stateDir, terminateProviderCleanupTarget, terminateVerified } from "./companion-shared.mjs";

function dispatchV1(candidate) {
