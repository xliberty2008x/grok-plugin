...
import { assertDispatchContract, prepareDispatchProcessSpawn, recordUnsettledWorkerProcess, recordDispatchProcessNoChild, transitionWorkerDispatch } from "./worker-mutation.mjs";
...
import { applyTaskPrivacy, currentHost, stateDir, touchJob, workerEnvironment } from "./companion-shared.mjs";
