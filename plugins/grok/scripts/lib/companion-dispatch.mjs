...
import { requiredProviderSpawnBinding } from "./companion-provider-admission.mjs";
...
import { applyTaskPrivacy, providerLaunchBinding, sessionId, stateDir, workerEnvironment } from "./companion-shared.mjs";
