...
import { baseRecord, out, providerLaunchBinding, publicJson, renderJob, researchResultJson, sessionId, stateDir, stdinReadySignal, touchJob, validateModelEffort, workerEnvironment } from "./companion-shared.mjs";
import { invalidProviderCapabilityError, requiredProviderSpawnBinding } from "./companion-provider-admission.mjs";
