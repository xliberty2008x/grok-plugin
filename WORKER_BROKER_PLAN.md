...
| P2.1 | **Source-complete, qualification pending:** broker-built ContextPacket, immutable role/profile/tool policy, and body-free Context Receipt bound to the exact provider prompt, canonical root lineage, manifest, and launch preparation | Stable 138/138 focused gate with zero skip/TODO; delayed-stdin legacy compatibility; deleted-binding anti-downgrade before execution and after authorization; generation-2 repair/error/cancellation; 22-case hostile context matrix; schema/runtime parity; clean diff; fresh native P0/P1-clear validation |
